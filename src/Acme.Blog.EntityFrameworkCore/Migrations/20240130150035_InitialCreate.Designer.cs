...
namespace Acme.Blog.Migrations
{
    ...
    [Migration("20240130150035_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.Blog.Blog.Entities.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Blog.Blog.Entities.ArticleContent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Blog.Blog.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Blog.Blog.Entities.Label", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Acme.Blog.Blog.Entities.ArticleContent", b =>
                {
                    b.HasOne("Acme.Blog.Blog.Entities.Article", null)
                        .WithOne("Content")
                        .HasForeignKey("Acme.Blog.Blog.Entities.ArticleContent", "ArticleId")
